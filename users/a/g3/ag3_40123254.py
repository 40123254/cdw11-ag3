...
ag3_40123254 = Blueprint('ag3_40123254', __name__, url_prefix='/ag3_40123254', template_folder='templates')




@ag3_40123254.route('/task4a')
def task4a():
    outstring = '''
<!DOCTYPE html>
<html>
