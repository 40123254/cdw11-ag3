...
a40123254_1 = Blueprint('a40123254_1', __name__, url_prefix='/a40123254_1', template_folder='templates')

@a40123254_1.route('/fourgear', defaults={'n1':15,'n2':20,'n3':18,'n4':20})
@a40123254_1.route('/fourgear/<n1>/<n2>/<n3>/<n4>')
